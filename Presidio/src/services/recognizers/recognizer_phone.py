...
class PhoneRecognizer(PatternRecognizer):
    ...
    - Consulta al ColombianIDRecognizer para evitar falsos positivos con documentos
    - Reconoce formatos comunes de números telefónicos en Latinoamérica
    """
    ...
    def validate_result(self, pattern_match, text=None, start=None, end=None) -> Tuple[bool, float]:
        ...
        Args:
            ...
            text: Texto completo (opcional, para análisis de contexto)
    ...
    def _is_likely_document(self, text: str, start: int, end: int, match_text: str) -> bool:
        ...
        Utiliza el reconocedor colombiano para evitar duplicar lógica.
        
        Args:
            text: Texto completo
            start: Posición inicial del número
            end: Posición final del número
            match_text: El texto detectado
            
        Returns:
            bool: True si es probablemente un documento, False en caso contrario
        """
    ...
    def analyze_context(self, text: str, start: int, end: int) -> float:
        ...
        Returns:
            float: Score adicional basado en contexto
        """
    ...
    def analyze(self, text: str, entities: List[str], nlp_artifacts: NlpArtifacts = None) -> List[RecognizerResult]:
        """
        Analiza el texto para encontrar números telefónicos, evitando confundirlos
        con documentos de identidad colombianos.
