...
class PresidioController:
    ...
    def preview_anonymization(self):
        ...
        try:
            ...
            elif request.form.get('text') or request.json and 'text' in request.json:
                source_type = 'text'
            ...
            language = request.form.get('language') or request.json and request.json.get('language') or 'en'
