...
class PresidioService:    def __init__(self):
        # Configurar el analizador para usar idioma español por defecto
        from presidio_analyzer import RecognizerRegistry
        registry = RecognizerRegistry()
        registry.load_predefined_recognizers()
        
        # Inicializar el analizador con el registro configurado y soporte para español
        ...
        self.target_entities = [
            ...
            "PHONE_NUMBER", 
            "LOCATION", 
            "DATE_TIME",  # Cambiado de TIME a DATE_TIME (nombre correcto)
            "NRP", # Número de cédula/documento (Colombian ID)
            "EMAIL_ADDRESS",
            "ADDRESS"
        ]
        
        # Umbral de puntuación fijo (ligeramente reducido para aumentar detecciones)
