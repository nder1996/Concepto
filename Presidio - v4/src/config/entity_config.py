...
ENTITY_THRESHOLDS_EN = {
    ...
    "LOCATION": 0.3,  # Umbral medio-bajo para capturar ubicaciones geográficas
}
...
ENTITY_THRESHOLDS_ES = {
    ...
    "LOCATION": 0.25,  # Umbral ligeramente más bajo para español para mejor detección de ubicaciones
}
